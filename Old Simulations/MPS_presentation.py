...
coil_thickness = 0.81 * 1e-3 #20 awg
...
for k in range(num_coils):
    ...
    difference[k_string] = d - l[k_string] #the separation vector (r-l)
...
fig.add_scatter3d(x=lx['0'], y=ly['0'], z=lz['0'], mode='lines', line=dict(color= 'pink'))
fig.add_scatter3d(x=lx['1'], y=ly['1'], z=lz['1'], mode='lines', line=dict(color= 'pink'))
fig.add_scatter3d(x=lx['2'], y=ly['2'], z=lz['2'], mode='lines', line=dict(color= 'pink'))
